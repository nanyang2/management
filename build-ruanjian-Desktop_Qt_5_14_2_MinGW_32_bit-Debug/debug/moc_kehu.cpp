/****************************************************************************
** Meta object code from reading C++ file 'kehu.h'
**
...
#include <memory>
#include "../../ruanjian/kehu.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'kehu.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_kehu_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_kehu_t qt_meta_stringdata_kehu = {
    {
QT_MOC_LITERAL(0, 0, 4), // "kehu"
...
QT_MOC_LITERAL(4, 52, 23) // "on_pushButton_2_clicked"
    ...
    "kehu\0on_pushButton_4_clicked\0\0"
...
QT_INIT_METAOBJECT const QMetaObject kehu::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_kehu.data,
    qt_meta_data_kehu,
    qt_static_metacall,
    nullptr,
    nullptr
...
void *kehu::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_kehu.stringdata0))
